const dummyData = {
  ...
  customizations: [
    ...
    // sizes
    { name: "Coke", price: 30, type: "size" },
    { name: "Fries", price: 35, type: "size" },
    { name: "Garlic Bread", price: 40, type: "size" },
    { name: "Chicken Nuggets", price: 50, type: "size" },
    { name: "Iced Tea", price: 28, type: "size" },
    { name: "Salad", price: 33, type: "size" },
    { name: "Potato Wedges", price: 38, type: "size" },
    { name: "Mozzarella Sticks", price: 45, type: "size" },
    { name: "Sweet Corn", price: 25, type: "size" },
    { name: "Choco Lava Cake", price: 42, type: "size" },
  ],
